!(function (e, t) {
  ...
  function v(e, t, n, r, i) {
    for (var o, a, s, l, u, c, d, f = e.length, v = p(t), y = [], b = 0; b < f; b++)
      if ((a = e[b]) || 0 === a)
        if ("object" === pe.type(a)) pe.merge(y, a.nodeType ? [a] : a);
          ...
          for (l = l || v.appendChild(t.createElement("div")), u = (ze.exec(a) || ["", ""])[1].toLowerCase(), d = Ge[u] || Ge._default, l.innerHTML = d[1] + pe.htmlPrefilter(a) + d[2], o = d[0]; o--; ) l = l.lastChild;
          if ((!de.leadingWhitespace && Ue.test(a) && y.push(t.createTextNode(Ue.exec(a)[0])), !de.tbody))
            for (o = (a = "table" !== u || Je.test(a) ? ("<table>" !== d[1] || Je.test(a) ? 0 : l) : l.firstChild) && a.childNodes.length; o--; ) pe.nodeName((c = a.childNodes[o]), "tbody") && !c.childNodes.length && a.removeChild(c);
    ...
    for (l && v.removeChild(l), de.appendChecked || pe.grep(h(y, "input"), g), b = 0; (a = y[b++]); )
      ...
      else if (((s = pe.contains(a.ownerDocument, a)), (l = h(v.appendChild(a), "script")), s && m(l), n)) for (o = 0; (a = l[o++]); ) Xe.test(a.type || "") && n.push(a);
    return (l = null), v;
  }
  function y() {
    return !0;
  ...
  function w(e, t, n, r, i, o) {
    var a, s;
    if ("object" == typeof t) {
      for (s in ("string" != typeof n && ((r = r || n), (n = void 0)), t)) w(e, s, n, r, t[s], o);
      return e;
    }
  ...
  function N(e, t, n, r) {
    ...
    if (d && ((i = (u = v(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === u.childNodes.length && (u = i), i || r)) {
      for (a = (s = pe.map(h(u, "script"), C)).length; c < d; c++) (o = u), c !== f && ((o = pe.clone(o, !0, !0)), a && pe.merge(s, h(o, "script"))), n.call(e[c], o, c);
      if (a)
        for (l = s[s.length - 1].ownerDocument, pe.map(s, E), c = 0; c < a; c++)
          (o = s[c]), Xe.test(o.type || "") && !pe._data(o, "globalEval") && pe.contains(l, o) && (o.src ? pe._evalUrl && pe._evalUrl(o.src) : pe.globalEval((o.text || o.textContent || o.innerHTML || "").replace(lt, "")));
      u = i = null;
    }
    return e;
  }
  ...
  function A(e) {
    ...
    return (
      n ||
        (("none" !== (n = D(e, t)) && n) ||
          ((t = ((ct = (ct || pe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || ct[0].contentDocument).document).write(), t.close(), (n = D(e, t)), ct.detach()),
        (dt[e] = n)),
      n
    );
  }
  ...
  function H(e) {
    if (e in St) return e;
    for (var t = e.charAt(0).toUpperCase() + e.slice(1), n = kt.length; n--; ) if ((e = kt[n] + t) in St) return e;
  }
  function q(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)
      (r = e[a]).style &&
        ...
        (n = r.style.display),
        t
          ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Ie(r) && (o[a] = pe._data(r, "olddisplay", A(r.nodeName))))
          : ((i = Ie(r)), ((n && "none" !== n) || !i) && pe._data(r, "olddisplay", i ? n : pe.css(r, "display"))));
  ...
  function R(e, t, n, r, i) {
    for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2)
      "margin" === n && (a += pe.css(e, n + Be[o], !0, i)),
        r
          ? ("content" === n && (a -= pe.css(e, "padding" + Be[o], !0, i)), "margin" !== n && (a -= pe.css(e, "border" + Be[o] + "Width", !0, i)))
          : ((a += pe.css(e, "padding" + Be[o], !0, i)), "padding" !== n && (a += pe.css(e, "border" + Be[o] + "Width", !0, i)));
    return a;
  }
  function _(e, t, n) {
    var r = !0,
    ...
    if (i <= 0 || null == i) {
      if ((((i = vt(e, t, o)) < 0 || null == i) && (i = e.style[t]), pt.test(i))) return i;
  ...
  function I(e, t, n) {
    ...
    1 === e.nodeType &&
      ...
      "inline" === ("none" === (u = pe.css(e, "display")) ? pe._data(e, "olddisplay") || A(e.nodeName) : u) &&
        "none" === pe.css(e, "float") &&
        (de.inlineBlockNeedsLayout && "inline" !== A(e.nodeName) ? (f.zoom = 1) : (f.display = "inline-block"))),
    n.overflow &&
      ((f.overflow = "hidden"),
      de.shrinkWrapBlocks() ||
        c.always(function () {
    ...
    if (pe.isEmptyObject(d)) "inline" === ("none" === u ? A(e.nodeName) : u) && (f.display = u);
    else
      ...
      d))
        (a = B(p ? h[r] : 0, r, c)), r in h || ((h[r] = a.start), p && ((a.end = a.start), (a.start = "width" === r || "height" === r ? 1 : 0)));
  }
  function W(e, t) {
    var n, r, i, o, a;
    for (n in e)
  ...
  function $(e, t, n) {
    var r,
      ...
      l = function () {
        if (i) return !1;
        for (var t = Nt || O(), n = Math.max(0, u.startTime + u.duration - t), r = 1 - (n / u.duration || 0), o = 0, a = u.tweens.length; o < a; o++) u.tweens[o].run(r);
      ...
      for ("boolean" == typeof a && ((u = a), (a = arguments[s] || {}), s++), "object" == typeof a || pe.isFunction(a) || (a = {}), s === l && ((a = this), s--); s < l; s++)
        if (null != (i = arguments[s]))
          for (r in i)
            (e = a[r]),
              a !== (n = i[r]) &&
                (u && n && (pe.isPlainObject(n) || (t = pe.isArray(n))) ? (t ? ((t = !1), (o = e && pe.isArray(e) ? e : [])) : (o = e && pe.isPlainObject(e) ? e : {}), (a[r] = pe.extend(u, o, n))) : void 0 !== n && (a[r] = n));
      return a;
    }),
    pe.extend({
  ...
  var ye = (function (e) {
      ...
      if (!r && ((t ? t.ownerDocument || t : B) !== H && L(t), (t = t || H), F)) {
        ...
        if (w.qsa && !X[e + " "] && (!R || !R.test(e))) {
          if (1 !== m) (h = t), (p = e);
            ...
            for ((s = t.getAttribute("id")) ? (s = s.replace(be, "\\$&")) : t.setAttribute("id", (s = P)), o = (d = k(e)).length, l = fe.test(s) ? "#" + s : "[id='" + s + "']"; o--; ) d[o] = l + " " + f(d[o]);
      ...
      return t.first
        ...
        : function (t, n, a) {
            ...
            if (a) {
              ...
              for (; (t = t[r]); )
                if (1 === t.nodeType || i) {
                  if ((s = (l = (u = t[P] || (t[P] = {}))[t.uniqueID] || (u[t.uniqueID] = {}))[r]) && s[0] === I && s[1] === o) return (c[2] = s[2]);
    ...
    (L = t.setDocument = function (e) {
      ...
      return r !== H && 9 === r.nodeType && r.documentElement
        ? ((q = (H = r).documentElement),
          ...
          (w.matchesSelector = ge.test((M = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector))) &&
            i(function (e) {
    ...
    (t.matchesSelector = function (e, n) {
      if (((e.ownerDocument || e) !== H && L(e), (n = n.replace(ce, "='$1']")), w.matchesSelector && F && !X[n + " "] && (!_ || !_.test(n)) && (!R || !R.test(n))))
        try {
          var r = M.call(e, n);
            ...
            : function (t, n, l) {
                ...
                if (g) {
                  ...
                  if (((h = [a ? g.firstChild : g.lastChild]), a && y)) {
                    for (b = (p = (u = (c = (d = (f = g)[P] || (f[P] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === I && u[1]) && u[2], f = p && g.childNodes[p]; (f = (++p && f && f[m]) || (b = p = 0) || h.pop()); )
                      if (1 === f.nodeType && ++b && f === t) {
                        c[e] = [I, p, b];
                        break;
                      }
                  } else if ((y && (b = p = (u = (c = (d = (f = t)[P] || (f[P] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === I && u[1]), !1 === b))
                    for (
                      ;
                      (f = (++p && f && f[m]) || (b = p = 0) || h.pop()) &&
                      ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && ((c = (d = f[P] || (f[P] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [I, b]), f !== t));
    ...
    return (
      ...
      (k = t.tokenize = function (e, n) {
        ...
        for (s = e, l = [], u = T.preFilter; s; ) {
          for (a in ((r && !(i = le.exec(s))) || (i && (s = s.slice(i[0].length) || s), l.push((o = []))),
          (r = !1),
          (i = ue.exec(s)) && ((r = i.shift()), o.push({ value: r, type: i[0].replace(se, " ") }), (s = s.slice(r.length))),
          T.filter))
            !(i = pe[a].exec(s)) || (u[a] && !(i = u[a](i))) || ((r = i.shift()), o.push({ value: r, type: a, matches: i }), (s = s.slice(r.length)));
          if (!r) break;
        }
      ...
      (S = t.compile = function (e, t) {
        var n,
          ...
          o = X[e + " "];
        if (!o) {
          for (t || (t = k(e)), n = t.length; n--; ) (o = y(t[n]))[P] ? r.push(o) : i.push(o);
      ...
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (this.length && ((i = pe.data(o)), 1 === o.nodeType && !pe._data(o, "parsedAttrs"))) {
            for (n = a.length; n--; ) a[n] && 0 === (r = a[n].name).indexOf("data-") && l(o, (r = pe.camelCase(r.slice(5))), i[r]);
  ...
  var Re,
    ...
    We = function (e, t, n, r, i, o, a) {
      var s = 0,
        l = e.length,
        u = null == n;
      if ("object" === pe.type(n)) for (s in ((i = !0), n)) We(e, t, s, n[s], !0, o, a);
      else if (
        void 0 !== r &&
        ((i = !0),
        pe.isFunction(r) || (a = !0),
  ...
  !(function () {
    ...
    for (t in { submit: !0, change: !0, focusin: !0 }) (n = "on" + t), (de[t] = n in e) || (r.setAttribute(n, "t"), (de[t] = !1 === r.attributes[n].expando));
    r = null;
  })();
        ...
        for (
          ...
          (p = m = (o = tt.exec(t[s]) || [])[1]),
            ...
            p &&
              ...
              (u = pe.event.special[p] || {}),
              (d = pe.extend({ type: p, origType: m, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && pe.expr.match.needsContext.test(i), namespace: h.join(".") }, l)),
      ...
      if (g && (c = g.events)) {
        for (u = (t = (t || "").match(Ae) || [""]).length; u--; )
          if (((p = m = (s = tt.exec(t[u]) || [])[1]), (h = (s[2] || "").split(".").sort()), p)) {
            for (d = pe.event.special[p] || {}, f = c[(p = (r ? d.delegateType : d.bindType) || p)] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = f.length; o--; )
              (a = f[o]),
                (!i && m !== a.origType) ||
                  (n && n.guid !== a.guid) ||
            ...
            l && !f.length && ((d.teardown && !1 !== d.teardown.call(e, h, g.handle)) || pe.removeEvent(e, p, g.handle), delete c[p]);
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !u.noBubble && !pe.isWindow(r)) {
          for (l = u.delegateType || p, et.test(l + p) || (s = s.parentNode); s; s = s.parentNode) f.push(s), (c = s);
        ...
        for (d = 0; (s = f[d++]) && !t.isPropagationStopped(); )
          (t.type = d > 1 ? l : u.bindType || p),
            ...
            (o = a && s[a]) && o.apply && He(s) && ((t.result = o.apply(s, n)), !1 === t.result && t.preventDefault());
        if (((t.type = p), !i && !t.isDefaultPrevented() && (!u._default || !1 === u._default.apply(f.pop(), n)) && He(r) && a && r[p] && !pe.isWindow(r))) {
        ...
        for (a = pe.event.handlers.call(this, e, l), t = 0; (i = a[t++]) && !e.isPropagationStopped(); )
          for (e.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !e.isImmediatePropagationStopped(); )
            (e.rnamespace && !e.rnamespace.test(o.namespace)) ||
              ((e.handleObj = o), (e.data = o.data), void 0 !== (r = ((pe.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (e.result = r) && (e.preventDefault(), e.stopPropagation()));
      ...
      if (s && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
        for (; l != this; l = l.parentNode || this)
          if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
            for (r = [], n = 0; n < s; n++) void 0 === r[(i = (o = t[n]).selector + " ")] && (r[i] = o.needsContext ? pe(i, this).index(l) > -1 : pe.find(i, this, null, [l]).length), r[i] && r.push(o);
  ...
  pe.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        (de.html5Clone || pe.isXMLDoc(e) || !rt.test("<" + e.nodeName + ">") ? (o = e.cloneNode(!0)) : ((ut.innerHTML = e.outerHTML), ut.removeChild((o = ut.firstChild))),
        !((de.noCloneEvent && de.noCloneChecked) || (1 !== e.nodeType && 11 !== e.nodeType) || pe.isXMLDoc(e)))
      )
        for (r = h(o), s = h(e), a = 0; null != (i = s[a]); ++a) r[a] && S(i, r[a]);
      if (t)
        if (n) for (s = s || h(e), r = r || h(o), a = 0; null != (i = s[a]); a++) k(i, r[a]);
        else k(e, o);
    ...
    function t() {
      ...
      d.appendChild(l),
        ...
        (o = 0 === u.getClientRects().length) &&
          ...
          (o = 0 === t[0].offsetHeight) && ((t[0].style.display = ""), (t[1].style.display = "none"), (o = 0 === t[0].offsetHeight))),
        d.removeChild(l);
    }
    var n,
      r,
    ...
    ? ((gt = function (t) {
      ...
      (vt = function (e, t, n) {
        var r,
          ...
          s = e.style;
        return (
          ("" !== (a = (n = n || gt(e)) ? n.getPropertyValue(t) || n[t] : void 0) && void 0 !== a) || pe.contains(e.ownerDocument, e) || (a = pe.style(e, t)),
          n && !de.pixelMarginRight() && pt.test(a) && ft.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o)),
          void 0 === a ? a : a + ""
        );
      }))
    : mt.currentStyle &&
      ...
      (vt = function (e, t, n) {
        var r,
          ...
          s = e.style;
        return (
          null == (a = (n = n || gt(e)) ? n[t] : void 0) && s && s[t] && (a = s[t]),
          pt.test(a) && !yt.test(t) && ((r = s.left), (o = (i = e.runtimeStyle) && i.left) && (i.left = e.currentStyle.left), (s.left = "fontSize" === t ? "1em" : a), (a = s.pixelLeft + "px"), (s.left = r), o && (i.left = o)),
          void 0 === a ? a : a + "" || "auto"
        );
      }));
  var bt = /alpha\([^)]*\)/i,
  ...
  pe.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (
          !("string" === (o = typeof n) && (i = Pe.exec(n)) && i[1] && ((n = f(e, t, i)), (o = "number")),
          null == n ||
            n != n ||
            ("number" === o && (n += (i && i[3]) || (pe.cssNumber[s] ? "" : "px")), de.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r))))
        )
          try {
            l[t] = n;
          } catch (e) {}
    ...
    de.opacity ||
      (pe.cssHooks.opacity = {
        get: function (e, t) {
          return xt.test((t && e.currentStyle ? e.currentStyle.filter : e.style.filter) || "") ? 0.01 * parseFloat(RegExp.$1) + "" : t ? "1" : "";
        },
        set: function (e, t) {
          var n = e.style,
            r = e.currentStyle,
  ...
  pe.fn.extend({
    val: function (e) {
      ...
      return arguments.length
        ...
        : i
        ? (t = pe.valHooks[i.type] || pe.valHooks[i.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(i, "value"))
          ? n
        ...
        select: {
          get: function (e) {
            for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, a = o ? null : [], s = o ? i + 1 : r.length, l = i < 0 ? s : o ? i : 0; l < s; l++)
              if (((n = r[l]).selected || l === i) && (de.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !pe.nodeName(n.parentNode, "optgroup"))) {
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ? pe.prop(e, t, n)
            : ((1 === o && pe.isXMLDoc(e)) || ((t = t.toLowerCase()), (i = pe.attrHooks[t] || (pe.expr.match.bool.test(t) ? Ft : qt))),
              void 0 !== n
                ? null === n
  ...
  pe.fn.extend({
    ...
    pe.extend({
      prop: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            (1 === o && pe.isXMLDoc(e)) || ((t = pe.propFix[t] || t), (i = pe.propHooks[t])), void 0 !== n ? (i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e[t] = n)) : i && "get" in i && null !== (r = i.get(e, t)) ? r : e[t]
          );
      },
      propHooks: {
        tabIndex: {
  ...
  pe.fn.extend({
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n
        ...
        : this.each(function () {
            var t, r, i, o;
            if ("string" === n) for (r = 0, i = pe(this), o = e.match(Ae) || []; (t = o[r++]); ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            else (void 0 !== e && "boolean" !== n) || ((t = z(this)) && pe._data(this, "__className__", t), pe.attr(this, "class", t || !1 === e ? "" : pe._data(this, "__className__") || ""));
          });
    },
    hasClass: function (e) {
      var t,
        n,
        r = 0;
      for (t = " " + e + " "; (n = this[r++]); ) if (1 === n.nodeType && (" " + z(n) + " ").replace(It, " ").indexOf(t) > -1) return !0;
      return !1;
    },
  }),
  ...
  pe.extend({
    ...
    ajaxSettings: {
      ...
      accepts: { "*": tn, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" },
    ...
    ajax: function (t, n) {
      function r(t, n, r, i) {
        ...
        2 !== x &&
          ...
          (b = Y(f, b, T, o)),
          o
            ? (f.ifModified && ((w = T.getResponseHeader("Last-Modified")) && (pe.lastModified[a] = w), (w = T.getResponseHeader("etag")) && (pe.etag[a] = w)),
              204 === t || "HEAD" === f.type ? (C = "nocontent") : 304 === t ? (C = "notmodified") : ((C = b.state), (d = b.data), (o = !(y = b.error))))
          ...
          g.fireWith(p, [T, C]),
          u && (h.trigger("ajaxComplete", [T, f]), --pe.active || pe.event.trigger("ajaxStop")));
      }
      ...
      if (
        ...
        (T.success = T.done),
        (T.error = T.fail),
        (f.url = ((t || f.url || nn) + "").replace(Ut, "").replace(Qt, rn[1] + "//")),
        (f.type = n.method || n.type || f.method || f.type),
        (f.dataTypes = pe
          .trim(f.dataType || "*")
          .toLowerCase()
          .match(Ae) || [""]),
        null == f.crossDomain && ((i = Kt.exec(f.url.toLowerCase())), (f.crossDomain = !(!i || (i[1] === rn[1] && i[2] === rn[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (rn[3] || ("http:" === rn[1] ? "80" : "443")))))),
        f.data && f.processData && "string" != typeof f.data && (f.data = pe.param(f.data, f.traditional)),
        U(Zt, f, n, T),
        2 === x)
      )
        return T;
      for (o in ((u = pe.event && f.global) && 0 == pe.active++ && pe.event.trigger("ajaxStart"),
      (f.type = f.type.toUpperCase()),
      (f.hasContent = !Jt.test(f.type)),
      (a = f.url),
      f.hasContent || (f.data && ((a = f.url += (zt.test(a) ? "&" : "?") + f.data), delete f.data), !1 === f.cache && (f.url = Vt.test(a) ? a.replace(Vt, "$1_=" + $t++) : a + (zt.test(a) ? "&" : "?") + "_=" + $t++)),
      ...
      T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + tn + "; q=0.01" : "") : f.accepts["*"]),
      f.headers))
        T.setRequestHeader(o, f.headers[o]);
      if (f.beforeSend && (!1 === f.beforeSend.call(p, T, f) || 2 === x)) return T.abort();
      for (o in ((w = "abort"), { success: 1, error: 1, complete: 1 })) T[o](f[o]);
      if ((c = U(en, f, n, T))) {
    ...
    pe.fn.extend({
      ...
      serializeArray: function () {
        return this.map(function () {
          ...
          .filter(function () {
            var e = this.type;
            return this.name && !pe(this).is(":disabled") && un.test(this.nodeName) && !ln.test(e) && (this.checked || !$e.test(e));
          })
          .map(function (e, t) {
            var n = pe(this).val();
            return null == n
              ...
              a.send((t.hasContent && t.data) || null),
                (n = function (e, r) {
                  ...
                  if (n && (r || 4 === a.readyState))
                    if ((delete dn[s], (n = void 0), (a.onreadystatechange = pe.noop), r)) 4 !== a.readyState && a.abort();
                    else {
    ...
    pe.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          ...
          s ? (t[s] = t[s].replace(hn, "$1" + i)) : !1 !== t.jsonp && (t.url += (zt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
          ...
          r.always(function () {
            void 0 === o ? pe(e).removeProp(i) : (e[i] = o), t[i] && ((t.jsonpCallback = n.jsonpCallback), pn.push(i)), a && pe.isFunction(o) && o(a[0]), (a = o = void 0);
          }),
          "script"
        );
    }),
    ...
    pe.fn.extend({
      offset: function (e) {
        ...
        return o
          ? ((t = o.documentElement),
            pe.contains(t, i)
              ? (void 0 !== i.getBoundingClientRect && (r = i.getBoundingClientRect()), (n = te(o)), { top: r.top + (n.pageYOffset || t.scrollTop) - (t.clientTop || 0), left: r.left + (n.pageXOffset || t.scrollLeft) - (t.clientLeft || 0) })
              : r)
          : void 0;
      },
      position: function () {
    ...
    var e = function (e, t) {
      ...
      (e.rails = n = {
          ...
          return (
            u.each(function () {
              (i = e(this)).is("input[type=radio]")
                ? ((a = i.attr("name")), c[a] || (0 === t.find('input[type=radio]:checked[name="' + a + '"]').length && ((o = t.find('input[type=radio][name="' + a + '"]')), (s = s.add(o))), (c[a] = a)))
                : (i.is("input[type=checkbox],input[type=radio]") ? i.is(":checked") : !!i.val()) === r && (s = s.add(i));
            }),
            !!s.length && s
          );
        },
        ...
        enableElement: function (e) {
          e.data("ujs:enable-with") !== t && (e.html(e.data("ujs:enable-with")), e.removeData("ujs:enable-with")), e.off("click.railsDisable"), e.removeData("ujs:disabled");
        },
      }),
  ...
  $(function () {
    $('a[href*="#"]:not([href="#"])').on("click", function () {
      if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
        var e = $(this.hash);
        if ((e = e.length ? e : $("[name=" + this.hash.slice(1) + "]")).length) return $("html,body").animate({ scrollTop: e.offset().top }, 600), !1;
      }
    });
  });
